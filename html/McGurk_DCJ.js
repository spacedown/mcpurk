...
function aud_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAud_trial of aud_trials) {
...
function vis_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisVis_trial of vis_trials) {
...
function AV_trialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAV_trial of AV_trials) {
...
function blkIntroRoutineBegin() {
  ...
  for (const thisComponent of blkIntroComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function aud_trialRoutineBegin() {
  ...
  for (const thisComponent of aud_trialComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function vis_trialRoutineBegin() {
  ...
  for (const thisComponent of vis_trialComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function AV_trialRoutineBegin() {
  ...
  for (const thisComponent of AV_trialComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function expEndRoutineBegin() {
  ...
  for (const thisComponent of expEndComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
